# -*- coding: utf-8 -*-
"""Copia de Python TOTAL - Machine Learning.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Qy9CZww6F1C6s05qCT3XIFMT5021K2zA
...
df = pd.read_csv('/content/drive/MyDrive/Mis_Colabs_CP/DataSet_Titanic.csv')
...
plt.title('Importnacia de cada atributo')
plt.show()
